...
class VQDualEnDecoderGenerator(nn.Module):
    """
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, 
        ...
        参数:
            ...
            decay (float) -- EMA衰减率
        """
        super(VQDualEnDecoderGenerator, self).__init__()
        ...
        # 编码器A（掌上超声）
        self.encoder_A = self._build_encoder(input_nc, ngf, norm_layer, use_bias, n_blocks, padding_type, use_dropout)
        
        # 编码器B（大型超声）
        self.encoder_B = self._build_encoder(input_nc, ngf, norm_layer, use_bias, n_blocks, padding_type, use_dropout)
    ...
    def _build_encoder(self, input_nc, ngf, norm_layer, use_bias, n_blocks, padding_type, use_dropout):
        ...
        for i in range(n_blocks):
            encoder += [ResnetBlock(ngf * mult, padding_type=padding_type, norm_layer=norm_layer, 
